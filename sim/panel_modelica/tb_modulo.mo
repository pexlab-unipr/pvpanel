model tb_modulo
  ...
  Pexlab.Mathplus.MatrixOutput matrix_output1(n_cols = 1, n_rows = 2, values = [250; 1000]) annotation(
  ...
  connect(pvcell_modulo1.n, ground.p) annotation(
  ...
  connect(matrix_output1.y, pvcell_modulo1.lights) annotation(
